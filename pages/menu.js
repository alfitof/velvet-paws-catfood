  ...
  return (
    <Layout>
      <div className={css.container}>
        <Head>
          <title>Velvet Paws Delight - Menu</title>
        ...
        <main>
          <section className="mt-28 md:mt-36 flex flex-col items-center">
              ...
              <button
                className={`px-4 py-2 rounded-full font-semibold focus:outline-none ${
                  selectedCategory === null
                    ...
                    : "border-[3px] border-orange-500 text-orange-500"
                }`}
            ...
            {/* Daftar makanan */}
            <div className="grid mb-14 mx-8 lg:mx-20 grid-cols-1 gap-7 md:grid-cols-3 lg:grid-cols-4">
              {catFoods.map((food) => {
